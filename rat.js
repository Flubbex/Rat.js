...
Rat.prototype = {
    path: function(opt, style) {
        return new Rat.Path(opt, style, this);
    },
    image: function(opt, style) {
        return new Rat.Image(opt, style, this);
    },
    text: function(opt, style) {
        return new Rat.Text(opt, style, this);
    },
...
Rat.Path.prototype = {
    ...
    isPointIn: function(x, y, ctx) {
        return this.process(function(ctx) {
